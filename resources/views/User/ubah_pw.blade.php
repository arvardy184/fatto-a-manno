<x-layout>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-1 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Change Password</h2>
        </div>
        <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form action="/change-password" method="post">
                @csrf
                <div class="mb-6">
                    <label for="password" class="block mb-1 text-sm font-semibold text-gray-700">Enter a new
                        password</label>
            ...
            <div>
                <a href="{{ url()->previous() }}"
                    class="mt-1 flex w-full justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
                    Back
                </a>
            </div>
        </div>
