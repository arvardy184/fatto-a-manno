<div class="bg-white">
    <form action="{{ route('All Products') }}" method="GET" x-data="{ test: false }">
        @if (session('errors'))
                            ...
                            <div x-show="expanded" class="pt-6" id="filter-section-mobile-1">
                                <div class="space-y-6">
                                    <div class="flex items-center">
                                        <input id="filter-mobile-type-0" name="type" value="Polo" type="checkbox"
                                    ...
                                    <div class="flex items-center">
                                        <input id="filter-mobile-type-3" name="type" value="Wallet" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-mobile-type-3"
                                            class="ml-3 min-w-0 flex-1 text-gray-500">Wallet</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-mobile-type-4" name="type" value="Hoodie" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    ...
                    <div class="hidden lg:block w-full">
                        ...
                        <div x-data="{ expanded: false }" class="border-b border-gray-200 py-6">
                            ...
                            <div x-show="expanded" class="pt-6" id="filter-section-1">
                                <div class="space-y-4">
                                    <div class="flex items-center">
                                        <input id="filter-type-0" name="type" value="Polo" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-0" class="ml-3 text-sm text-gray-600">Polo</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-1" name="type" value="Turtleneck" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                    ...
                                    <div class="flex items-center">
                                        <input id="filter-type-2" name="type" value="Plain t-shirt"
                                            type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-2" class="ml-3 text-sm text-gray-600">Plain
                                            t-shirt</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-3" name="type" value="Wallet" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-3" class="ml-3 text-sm text-gray-600">Wallet</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-4" name="type" value="Hoodie" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-4" class="ml-3 text-sm text-gray-600">Hoodie</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-4" name="type" value="Pants" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-4" class="ml-3 text-sm text-gray-600">Pants</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-4" name="type" value="Caps" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-4" class="ml-3 text-sm text-gray-600">Caps</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-4" name="type" value="Shirt" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-4" class="ml-3 text-sm text-gray-600">Shirt</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-type-4" name="type" value="Sweater" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-type-4" class="ml-3 text-sm text-gray-600">Sweater</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        <input id="filter-size-1" name="sorting" value="1" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-size-1" class="ml-3 text-sm text-gray-600">Price: Low
                                            to
                                            High</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="filter-size-2" name="sorting" value="2" type="checkbox"
                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        <label for="filter-size-2" class="ml-3 text-sm text-gray-600">Price: High
                                            to
                                            Low</label>
                                    </div>
                                </div>
