                            ...
                            <div class="hidden lg:block w-full">
                                ...
                                <div class=" flex justify-between px-12">
                                    ...
                                    <div x-data="{ expanded: false }" class=" border-gray-200 py-6 block w-40">
                                        ...
                                        <!-- Filter section, show/hide based on section state. -->
                                        <div x-show="expanded"
                                            class="pt-1 border hidden z-10 rounded-md shadow w-full mt-1"
                                            id="filter-section-3">
                                            <div class="space-y-4 px-3 py-2">
                                                <div class="flex items-center">
                        ...
                        <tbody>
                            @foreach ($clothes as $cloth)
                                <tr class="bg-gray-100 even:bg-gray-200">
                                    ...
                                    <td class="px-4 py-2 border">Rp{{ formatRupiah($cloth['price_per_piece']) }}</td>
                                    ...
                                    <td class="px-4 py-2 border">
                                        ...
                                        <div x-data="{ deletee: false }">
                                            ...
                                            <div x-show="deletee" id="deletee" class="relative z-10 hidden"
                                                        ...
                                                        <div
                                                            ...
                                                            <div x-transition:enter="ease-out duration-300"
                                                                    ...
                                                                    <div class="sm:flex sm:items-start">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h3 class="text-base font-semibold leading-6 text-gray-900"
                                                                                id="modal-title">Are you sure you want
                                                                                to delete it?</h3>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    ...
                                                                    <button @click="$refs.submitButton.click()"
                                                                        type="submit"
