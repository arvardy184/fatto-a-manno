{{-- user start --}}
{{-- Seno: jika yang login user, ini yang keluar --}}
<header class="bg-white" x-data="{ isOpen: false }">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 w-full" aria-label="Global">
        <div class="flex lg:hidden">
            <button onclick="document.querySelector('#mobile-men').classList.remove('hidden')" type="button"
        ...
        <div class="fixed right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <div class="me-3">
                <button type="button" <i class="fa-solid fa-cart-shopping fa-xl" style="color: #000000;"></i>
                </button>
            </div>
            <div class="me-1">
                <button type="button" <i class="fa-solid fa-bell fa-xl" style="color: #000000;"></i>
                </button>
            </div>
            <!-- Profile dropdown -->
            <div x-data="{ isOpen: false }" class="relative ml-3">
                ...
                <div x-show="isOpen" x-transition:enter="transition ease-out duration-100"
                    ...
                    <a href="/dashboard/profile" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
    ...
    <div id="mobile-men" class="lg:hidden hidden" role="dialog" aria-modal="true">
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                ...
                <button onclick="document.querySelector('#mobile-men').classList.add('hidden')" type="button"
            ...
            <div class="mt-6 flow-root">
                ...
                -->
                                <svg :class="{ 'rotate-180': isOpen, '': !isOpen }" class="h-5 w-5 flex-none"
                            ...
                            <div x-show="isOpen" class="mt-2 space-y-2" id="disclosure-1">
                                <a href="#"
...
{{-- Seno: jika yang login admin, ini yang keluar --}}
{{-- admin start --}}
<header class="bg-white" x-data="{ isOpen: false }">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 w-full" aria-label="Global">
        <div class="flex lg:hidden">
